...
//
	...
	Shader lightingShader("courses/005_color/shader_lighting.vs", "courses/005_color/shader_lighting.fs");	
	...
	Shader objectShader("courses/005_color/shader.vs", "courses/005_color/shader.fs");
	objectShader.use();
