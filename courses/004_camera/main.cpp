...
//
	...
	Shader ourShader("courses/004_camera/shader.vs", "courses/004_camera/shader.fs");	
	...
	viewMat = glm::lookAt(View::cameraPos, View::cameraPos + View::cameraFront, View::cameraUp);
	...
	while(!view->shouldClose()) {
		...
		glfwPollEvents();
		processInput(view->getWindow(), View::cameraPos, View::cameraFront, View::cameraUp, cameraSpeed);
